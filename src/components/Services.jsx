...
// Icons
import { RiMailFill, RiSmartphoneFill, RiMacFill, RiCompasses2Fill, RiColorFilterFill } from "react-icons/ri";
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4">
                ...
                <form className="w-full mt-4">
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            className="w-full bg-gray-200 py-4 pl-12 pr-36 rounded-xl outline-none"
                            placeholder="Enter your email address"
                        />
                        <button
                            type="submit"
                            className="absolute font-semibold py-2 px-6 bg-primary text-white rounded-xl top-1/2 -translate-y-1/2 right-2 shadow-blue"
                        >
                            Suscribe
                        </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-2">
                    <RiColorFilterFill className="text-4xl p-2 bg-secondary text-primary box-content rounded-xl" />
